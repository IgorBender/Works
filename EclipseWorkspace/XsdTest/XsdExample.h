...
#ifndef CXX_HOME_IGOR_TESTS_CMAKE_WORKSPACE_XSD_TEST_XSD_EXAMPLE_H
#define CXX_HOME_IGOR_TESTS_CMAKE_WORKSPACE_XSD_TEST_XSD_EXAMPLE_H
...
namespace XsdExample
{
  class PurchaseOrderType: public ::xml_schema::type
  {
    public:
    // ShipTo
    //
    typedef ::XsdExample::USAddress ShipTo_type;
    typedef ::xsd::cxx::tree::sequence< ShipTo_type > ShipTo_sequence;
    typedef ShipTo_sequence::iterator ShipTo_iterator;
    typedef ShipTo_sequence::const_iterator ShipTo_const_iterator;
    typedef ::xsd::cxx::tree::traits< ShipTo_type, char > ShipTo_traits;

    const ShipTo_sequence&
    ShipTo () const;
    ...
    // BillTo
    //
    typedef ::XsdExample::USAddress BillTo_type;
    typedef ::xsd::cxx::tree::traits< BillTo_type, char > BillTo_traits;
    ...
    // Constructors.
    //
    PurchaseOrderType (const BillTo_type&);

    PurchaseOrderType (::std::unique_ptr< BillTo_type >);
    ...
    protected:
    ShipTo_sequence ShipTo_;
    ::xsd::cxx::tree::one< BillTo_type > BillTo_;
    OrderDate_optional OrderDate_;
  };

  class USAddress: public ::xml_schema::type
  {
    public:
    // name
    //
    ...
    // zip
    //
    typedef ::xml_schema::integer zip_type;
...
namespace XsdExample
{
  ...
  PurchaseOrder (const ::std::string& uri,
                 ::xml_schema::flags f = 0,
  ...
  ::std::unique_ptr< ::XsdExample::PurchaseOrderType >
  PurchaseOrder (::xercesc::InputSource& is,
                 ::xml_schema::flags f = 0,
                 const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  ::std::unique_ptr< ::XsdExample::PurchaseOrderType >
  PurchaseOrder (const ::xercesc::DOMDocument& d,
                 ::xml_schema::flags f = 0,
                 const ::xml_schema::properties& p = ::xml_schema::properties ());
...
namespace XsdExample
{
  ...
  void
  PurchaseOrder (::std::ostream& os,
                 const ::XsdExample::PurchaseOrderType& x, 
  ...
  void
  PurchaseOrder (::xercesc::XMLFormatTarget& ft,
                 const ::XsdExample::PurchaseOrderType& x, 
                 const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                 const ::std::string& e = "UTF-8",
                 ::xml_schema::flags f = 0);
  ...
  PurchaseOrder (const ::XsdExample::PurchaseOrderType& x, 
                 const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                 ::xml_schema::flags f = 0);

  void
  operator<< (::xercesc::DOMElement&, const PurchaseOrderType&);

  void
  operator<< (::xercesc::DOMElement&, const USAddress&);
}
...
#endif // CXX_HOME_IGOR_TESTS_CMAKE_WORKSPACE_XSD_TEST_XSD_EXAMPLE_H
