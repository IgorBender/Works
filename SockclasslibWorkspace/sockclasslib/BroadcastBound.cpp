...
BroadcastBound::BroadcastBound(short Port, in_addr_t Address) throw(SockException)
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
BroadcastBound::BroadcastBound(short Port, const char* Address) throw(SockException)
#else
