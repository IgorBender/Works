...
DatagramSocket::DatagramSocket(int protocol) throw(SockException) : ConnectedSocketV4()
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
int DatagramSocket::sendTo(const void* Buffer, size_t Length, int Flags) throw(SockException)
#else
