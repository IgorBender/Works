...
void MulticastSocketV6::setTTL(unsigned char ttl) throw(SockException)
{
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
void MulticastSocketV6::setDefaultIf(in6_addr Address) throw(SockException)
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
void  MulticastSocketV6::setDefaultIf(const char* Address) throw(SockException)
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
void MulticastSocketV6::setDefaultIf(unsigned int Index) throw (SockException)
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
void MulticastSocketV6::setLoopBack(bool On) throw(SockException)
{
