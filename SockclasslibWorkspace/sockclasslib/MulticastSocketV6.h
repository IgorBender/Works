...
public:
    ...
    /// Constructor.
    /// \throw SockException.
    MulticastSocketV6() throw (SockException) : m_Index(0U)
    {
    }
#else
    ...
    /// \throw SockException.
    void setDefaultIf(in6_addr Address) throw (SockException);
    /// Set default network interface.
...
private:
    ...
    /// \throw SockException.
    void setDefaultIf(unsigned int Index) throw (SockException);
#else
