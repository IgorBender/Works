...
DatagramBound::DatagramBound(short Port, in_addr_t Address) throw(SockException)
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
DatagramBound::DatagramBound(short Port, const char* Address) throw(SockException)
#else
