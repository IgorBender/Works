...
public:
    ...
    /// \throw SockException
    DatagramSocketV6(int protocol = 0) throw (SockException);
#else
    ...
    /// \throw SockException
    int sendTo(const void* Buffer, size_t Length, int Flags = 0) throw (SockException);
    ...
    /// \param Flags : flags, default value - 0.
    /// \throw SockException
    int sendToLast(const void* Buffer, size_t Length, int Flags = 0) throw (SockException)
    {
    ...
    /// \param Flags : flags, default value - 0.
    /// \throw SockException
    int receiveFrom(void* Buffer, size_t Length, int Flags = 0) throw (SockException);
#else
