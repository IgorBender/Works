...
void MulticastSocket::setTTL(unsigned char ttl) throw(SockException)
{
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
void MulticastSocket::setDefaultIf(in_addr_t Address) throw(SockException)
{
    in_addr rAddr;
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
void  MulticastSocket::setDefaultIf(const char* Address) throw(SockException)
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
void MulticastSocket::setLoopBack(bool On) throw(SockException)
{
