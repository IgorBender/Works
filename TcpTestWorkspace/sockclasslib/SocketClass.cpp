...
void SocketClass::create() throw(SockException)
{
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
void SocketClass::setNonBlockMode(bool On) throw(SockException)
{
    int Result;
#ifndef _WIN32
    if(On)
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
int SocketClass::send(const void* Buffer, size_t Length, int Flags) throw(SockException, DisconnectException)
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
int SocketClass::receive(void* Buffer, size_t Length, int Flags) throw(SockException, DisconnectException)
#else
