...
StreamSocketV4::StreamSocketV4() throw(SockException)
#else
...
#ifndef _WITHOUT_SOCK_EXCEPTIONS
sockaddr_in& StreamSocketV4::getSockName() throw(SockException)
{
    if(!m_GotSockName)
    {
...
sockaddr_in& StreamSocketV4::getPeerName() throw(SockException)
{
    if(!m_GotPeerName)
    {
